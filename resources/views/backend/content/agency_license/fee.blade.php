...
<script type="text/javascript">
  ...
  $("#add2").click(function() {
    ...
    $("#dynamicTable2").append('<tr><td><select class="form-control section" name="addMoreInputFields[0][section_id]"id="addMoreInputFields[0][section_id]"><option value="" disabled selected>সেকশনের নাম:</option>@foreach ($section as $section_val)<option value="{{ $section_val->section_id }}">{{ $section_val->section_name }}</option>@endforeach</select><p class="text-danger error mt-2"></p></td><td><input type="text" name="addMoreInputFields[0][acq_case]"placeholder="Enter case number" class="form-control" /><p class="text-danger error mt-2"></p></td><td><input type="text" name="addMoreInputFields[0][gadget]"placeholder="Enter gadget name" class="form-control" /><p class="text-danger error mt-2"></p></td><td><input type="text" name="addMoreInputFields[0][page_no]"placeholder="Enter page no" class="form-control agriculture_validation " /><p class="text-danger error mt-2"></p></td><td><input type="date" name="addMoreInputFields[0][gadget_date]"placeholder="Enter gadget name" class="form-control" /><p class="text-danger error mt-2"></p></td><td><button type="button" class="btn btn-danger remove-tr2">Remove</button></td></tr>');
  });
