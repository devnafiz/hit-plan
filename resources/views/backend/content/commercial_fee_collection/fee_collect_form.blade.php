...
<x-backend.card>
    ...
    <x-slot name="headerActions">
        <x-utils.link-header class="btn btn-sm btn-tool btn-info" icon="fas fa-backspace" :href="route('admin.commercial.show', $license->id)" :text="__('Back to License page')" />
    ...
    <x-slot name="body">
        ...
        {{ html()->form('POST', route('admin.commercial-fees.store'))->id('ownerForm')->attribute('enctype', 'multipart/form-data')->attribute('next', 'fee-tab')->open() }}
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                ...
                <?php $balam_last_to_date = $license_balam->pluck('to_date')->last(); ?>
                <input type="hidden" name="license_number" id="license_number" value="{{ $license->generated_id }}">
                <input type="hidden" name="last_fee_date" id="last_fee_date" value="{{ date('Y-m-d', strtotime($balam_last_to_date)) }}">
                                ...
                                <table class="license_details_table_2">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="license_vat" data-key="license_vat" id="license_vat" placeholder="ভ্যাট" maxlength="11" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="license_tax" maxlength="11" data-key="license_tax" id="license_tax" placeholder="উৎসে কর" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
