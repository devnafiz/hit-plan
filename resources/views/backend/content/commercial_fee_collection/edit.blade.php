                                        ...
                                        <tr>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    @if ($errors->has('license_fee_to_dd'))
                                                    <p class="text-danger">
                                                        <small>{{ $errors->first('license_fee_to_dd') }}</small>
                                                    </p>
                                                    @endif
                                                </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endphp
                                    <h6 class="">বর্গফুট
                                        প্রতি <strong>{{ bangla_number($license->station->fee_rate) }}</strong> টাকা
                                    </h6>
                                    <p id="license_fee_calculated_data">
                                        জমির পরিমান: {{ number_format($total) }} বর্গফুট
                                        <br>
                                        মোট: {{ number_format($balam->license_fee) }}/-
                                        <br>
                                        ভ্যাট: {{ number_format($balam->vat) }}/-
                                        <br>
                                        ট্যাক্স: {{ number_format($balam->tax) }}/-
                                        <br>
                                        জরিমানা: {{ number_format($balam->fine) }}/-
                                        <br><br>
                                        মোট ফি: {{ number_format($balam->total_fee) }}/-
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div id="dd_form_repeater">
                                        ...
                                        <table class="dd_repeater_item license_details_table_2" data-key="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th><label for="license_dd_total_amount_0">টাকার পরিমাণ</label>
                                                    </th>
                                                    <td>
