...
<x-backend.card>
    ...
    <x-slot name="headerActions">
        <x-utils.link-header class="btn btn-sm btn-tool btn-info" icon="fas fa-backspace" :href="route('admin.agency.show', $license->id)" :text="__('Back to License page')" />
    ...
    <x-slot name="body">
        ...
        {{ html()->form('POST', route('admin.agency-license-fees.store'))->id('ownerForm')->attribute('enctype', 'multipart/form-data')->attribute('next', 'fee-tab')->open() }}
        <input type="hidden" id="license_fee_calculator" value="{{ route('admin.agency.license.fee.calculator') }}" />
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="hidden" id="license_owner_id" name="license_owner_id" value="{{$owner->id}}" />
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="">
                                    <table class="license_details_table_2">
                                        <tbody>
                                            <tr>
                                                <td style="width: 43%; padding-left:200px;">
                ...
                <div class="row save-button-container1" id="save-button-container1">
                    <div class="col-12">
