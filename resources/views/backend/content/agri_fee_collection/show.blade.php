                                        ...
                                        <div class="mb-3">
                                            <table class="text-center table-striped license_details_table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>কাচারী নং</th>
                                                        <td>{{ $balam->agriLicense->kachari->kachari_name }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>জেলা</th>
                                                        <td>{{ $balam->agriLicense->district->district_name }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>উপজেলা</th>
                                                        <td>{{ $balam->agriLicense->upazila->upazila_name }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>স্টেশন</th>
                                                        <td>{{ $balam->agriLicense->station->station_name }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="text-center license_details_table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $balam->agriLicense->demand_notice_number }} </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th>নকশা নং</th>
                                                        <td>{{ $balam->agriLicense->land_map_number ?? 'N/A' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>নকশার তারিখ</th>
                                                        <td>{{ $balam->agriLicense->land_map_date ?? 'N/A' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th>চৌহদ্দি</th>
                                                        <td>
                                                            উত্তর: {{ $balam->agriLicense->land_map_north }},
                                                            দক্ষিণ: {{ $balam->agriLicense->land_map_south }},
                                                            পূর্ব: {{ $balam->agriLicense->land_map_east }},
                                                            পশ্চিম: {{ $balam->agriLicense->land_map_west }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>কি.মি.</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (file_exists(public_path('uploads/agriculture/' . $balam->agriLicense->land_map_certificate)))
                                                            <a href="{{ asset('uploads/agriculture/' . $balam->agriLicense->land_map_certificate) }}" download="">Download <icon class="fas fa-file-download"></icon></a>
                                                            @else
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @php
                                        $all_moujas = $balam->agriLicense->agriMoujas;
                                        $total = 0;
