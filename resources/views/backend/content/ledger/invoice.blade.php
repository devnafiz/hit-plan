                ...
                <div>
                    ...
                    <table class="table table-borderless table-sm">
                        <tr class="border-bottom">
                            ...
                            <td></td>
                            <td><b>Invoice
                                    Date:</b>{{ date('d/m/Y', strtotime($patient->updated_at)) }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr class="border-bottom">
                            <td><b>NID:</b>{{ $patient->nid_no ? $patient->nid_no : 'N/A' }}
                            </td>
                            <td><b>Passport:</b>{{ $patient->passport_no ? $patient->passport_no : 'N/A' }}
                            </td>
                            <td></td>
                        </tr>
                    </table>
                    ...
                    <table class="table table-borderless table-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-right border-bottom">
                                ...
                                <b>Discount:
                                    {{ $patient->discount ? $patient->discount : '0.00' }}
                                    BDT</b> <br>
