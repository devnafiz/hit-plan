...
<x-backend.card>
    ...
    <x-slot name="body">
                                    ...
                                    <div id="dd_form_repeater">
                                        <table class="dd_repeater_item license_details_table_2" data-key="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th><label for="license_fee_ddn_no_0">লাইসেন্স ফি'র ‘এ চালান’ নং</label>
                                                    </th>
                                                    <td>
                                                        <input type="text" class="form-control" id="license_fee_ddn_no_0" placeholder="লাইসেন্স ফি'র ‘এ চালান’ নং" name="license_fee_dd[dd_no][0]" maxlength="11" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><label for="license_vat_dd_no_0">ভাটের ‘এ চালান’ নং</label></th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th><label for="license_bank_name_0">ব্যাংক ও শাখার নাম </label></th>
                                                    <td>
        ...
        <div class="row save-button-container" id="save-button-container">
            <div class="col-12">
                <button type="submit" class="btn btn-lg btn-dark float-right">সেভ করুন</button>
            </div>
        </div>
