...
<x-backend.card>
    ...
    <x-slot name="headerActions">
        <x-utils.link-header class="btn btn-sm btn-tool btn-info" icon="fas fa-backspace" :href="route('admin.pond-license.show', $license->id)" :text="__('Back to License page')" />
    ...
    <x-slot name="body">
        ...
        {{ html()->form('POST', route('admin.pond-license-fees.store'))->id('ownerForm')->attribute('enctype', 'multipart/form-data')->attribute('next', 'fee-tab')->open() }}
                        ...
                        <div class="table-responsive-sm">
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (file_exists(public_path('uploads/pond/' . $license->land_map_certificate)))
                                        <a href="{{ asset('uploads/pond/' . $license->land_map_certificate) }}" download>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="land_type" id="inlineRadio1" value="with-water" checked>
                                                <label class="form-check-label" for="inlineRadio1">পানি ভর্তি</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="land_type" id="inlineRadio2" value="without-water">
