...
@section('content')
    ...
    <x-backend.card>
        <x-slot name="header">
            @lang('জলাশয় লাইসেন্স ফি আদায় ফরম')
        </x-slot>
        ...
        <x-slot name="body">
            ...
            {{ html()->form('PUT', route('admin.pond-license-fees.update', $id))->id('ownerForm')->attribute('enctype', 'multipart/form-data')->attribute('next', 'fee-tab')->open() }}
            <input type="hidden" id="license_fee_route" value="{{ route('admin.pond.license.fee.details') }}" />
            <input type="hidden" id="license_fee_calculator" value="{{ route('admin.pond.license.fee.calculator') }}" />
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    ...
                    <div class="">
                                                ...
                                                <div class="table-responsive-sm table-striped">
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($license->land_map_certificate && file_exists(public_path($license->land_map_certificate)))
                                                                    <a href="{{ $license->land_map_certificate }}"
                                                                        download>Download</a>
                                                                @else
                        ...
                        <?php $balam_last_to_date = $balam->pluck('to_date')->last(); ?>
                        <input type="hidden" name="license_number" id="license_number"
                            value="{{ $license->generated_id }}">
                        <input type="hidden" name="last_fee_date" id="last_fee_date"
                            value="{{ date('Y-m-d', strtotime($balam_last_to_date)) }}">
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="card">
                                    <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="from_date[license_fee_from_mm]"
                                                        ...
                                                        @foreach ($bn_months as $key => $month)
                                                            <option value="{{ $key + 1 }}"
                                                                @if ($last_from_month == $key + 1) selected @endif>
                                                                {{ $month }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="from_date[license_fee_from_yy]"
                                                        ...
                                                        @for ($i = date('Y', strtotime('+5 years')); $i >= 1893; $i--)
                                                            <option value="{{ $i - 593 }}"
                                                                @if ($last_from_year == $i - 593) selected @endif>
                                                                {{ bangla_number($i - 593) }}
                                                            </option>
                                                        @endfor
                                                    </select>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <select class="form-control" name="to_date[license_fee_to_mm]"
                                                        ...
                                                        @foreach ($bn_months as $key => $month)
                                                            <option value="{{ $key + 1 }}"
                                                                @if ($last_to_month == $key + 1) selected @endif>
                                                                {{ $month }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <select class="form-control" name="to_date[license_fee_to_yy]"
                                                        ...
                                                        @for ($i = date('Y', strtotime('+5 years')); $i >= 1893; $i--)
                                                            <option value="{{ $i - 593 }}"
                                                                @if ($last_to_year == $i - 593) selected @endif>
                                                                {{ bangla_number($i - 593) }}
                                                            </option>
                                                        @endfor
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">জমির অবস্থা</div>
                                            <td class="col-md-9">
                                                <div class=" form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="land_type"
                                                        id="inlineRadio1" value="with-water"
                                                        @if ($balam->land_type == 'with-water') checked @endif>
                                                    <label class="form-check-label" for="inlineRadio1">পানি ভর্তি</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="land_type"
                                                        id="inlineRadio2" value="without-water"
                                                        @if ($balam->land_type == 'without-water') checked @endif>
                                                    <label class="form-check-label" for="inlineRadio2">পানি ছাড়া
                                                        (শুকনা)</label>
                                                </div>
                                            </td>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-3">
                                                <label
                                                    class="btn btn-sm btn-outline-primary float-right date-submit">Submit</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @php
                                            $total = $balam->pondLicense->pondMoujas->sum('leased_area');
                                        @endphp
                                        ...
                                        <table class="license_details_table_2">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control license_fee-calculator"
                                                            name="license_fee" maxlength="11" id="license_fee"
                                                            placeholder="লাইসেন্স ফি"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control license_fee-calculator"
                                                            name="license_vat" data-key="license_vat" id="license_vat"
                                                            placeholder="ভ্যাট" maxlength="11"
                                                            value="{{ $balam->vat ?? '' }}" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control license_fee-calculator"
                                                            name="license_tax" data-key="license_tax" maxlength="11"
                                                            id="license_tax" placeholder="উৎসে কর"
                                                            value="{{ $balam->tax ?? '' }}" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="license_fee-calculator form-control"
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <input type="hidden" name="dd_id_{{ $key }}"
                                                                value="{{ $dd->id }}">
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="date" class="form-control"
                                                                    ...
                                                                    value="{{ $dd->dd_date ? date('Y-m-d', strtotime($dd->dd_date)) : '' }}" />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="width: 48%; padding-left:160px;">
                                                                    <label
                                                                        for="license_dd_total_amount_{{ $key }}">টাকার
                                                                        পরিমাণ</label></th>
                                                                <td style="width: 52%;">
                                                                    <input type="number" class="form-control"
                                                                        name="license_fee_dd[total][{{ $key }}]"
                                                                        value="{{ $dd->total }}"
