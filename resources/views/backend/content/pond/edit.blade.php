...
@section('title', __('জলাশয় লাইসেন্স সংশোধন '))
...
{{ html()->modelForm($result, 'PUT', route('admin.pond-license.update', $result))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
<x-backend.card>
    <x-slot name="header">
        @lang('তথ্য সংশোধন ')
    </x-slot>
    ...
    <x-slot name="headerActions">
        <x-utils.link-header class="btn btn-sm btn-tool btn-secondary" icon="fas fa-backspace" :href="route('admin.pond-license.index')" :text="__('Cancel')" />
    </x-slot>
    ...
    <x-slot name="body">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                ...
                @forelse ($result->pondOwner as $key => $owner)
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group mt-1">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="owner[{{ $key }}][nameOption]" id="fatherName" value="fatherName" @if ($owner->father_name) checked @endif @if ($owner->father_name == null && $owner->husband_name == null ) checked @endif>
                ...
                <div class="row" id="license_owner_repeat_item_0">
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="owner[0][nameOption]" id="husbendName" value="husbendName">
                                <label class="form-check-label" for="husbendName">
                                    স্বামীর নাম
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control nid_validation" id="nid_0" name="owner[0][nid]" value="{{ old('owner.0.nid]') }}" placeholder="জাতীয় পরিচয়পত্র নং" maxlength="20" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="mobile_0">মোবাইল নং</label>
                            <input type="text" id="mobile_0" class="form-control ledger_amount" name="owner[0][phone]" placeholder="Phone Number" class="form-control" value="{{ old('owner.0.phone]') }}" maxlength="15" />
                        </div>
                        <div class="form-group">
        ...
        <div class="row bg-light text-justify mt-4 mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" name="demand_notice_number" id="demand_notice_number" placeholder="ডিমান্ড নোটিশের নং" value="{{ $result->demand_notice_number }}">
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 pl-4 pr-4">
                <table class="table table-bordered" id="license_moujas">
                    <tr>
                        ...
                        <th>ইজারা পরিমাণ</th>
                        <th>
                            <button type="button" class="btn btn-sm btn-primary" id="addMoujas" data-key="{{ count($licenseMoujas) }}">
                    ...
                    <tr>
                        ...
                        <td style="width: 10%;">
                            <select class="form-control ledger_id" id="ledger_id_0" data-target="#plot_id_{{ $key }}" name="mouja[{{ $key }}][ledger_id]">
                                ...
                                <option value="{{ $ledger->id }}" @if ($ledger->id == $mouja->ledger_id) selected @endif>
                        ...
                        <td style="width:10%;">
                            <a href="{{ route('admin.pond_mouja.delete', $mouja) }}" type="button" data-method="delete-post" class="btn btn-outline-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </table>
        ...
        <div class="row">
            <div class="col-md-2 text-right">
                <div class="form-group">
                    <label for="pond_plot_no">জলাশয় প্লট নং:</label>
                </div>
            </div>
            <div class="col-md-3">
                <textarea rows="2" col="5" class="form-control" id="pond_plot_no" name="pond_plot_no">{{ $result->pond_plot_no }}</textarea>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-2 text-right">
                <div class="form-group">
                    <label for="pond_plot_no">জমির অবস্থা:</label>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="land_type" id="inlineRadio1" value="12" @if ($result->land_type == 12) checked @endif>
                    <label class="form-check-label" for="inlineRadio1">সারা বছর পানি থাকে (১২ মাস)</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="land_type" id="inlineRadio2" value="6" @if ($result->land_type == 6) checked @endif>
                    <label class="form-check-label" for="inlineRadio2">ছয় মাস পানি থাকে (৬ মাস)</label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="exampleFormControlInput15" placeholder="নকশা নং" name="land_map_number" value="{{ $result->land_map_number }}" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input type="date" class="form-control" name="land_map_date" id="exampleFormControlInput16" value="{{ date('Y-m-d', strtotime($result->land_map_date)) }}" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control ledger_amount" id="exampleFormControlInput21" placeholder="কি.মি" name="land_map_kilo" value="{{ $result->land_map_kilo }}" maxlength="11" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                @if ($result->land_map_certificate && file_exists(public_path('uploads/pond/' . $result->land_map_certificate)))
                <a class="text-black" href="{{ asset('uploads/pond/' . $result->land_map_certificate) }}" download><i class="fa fa-file fa-3x" aria-hidden="true"></i></a>
                @else
