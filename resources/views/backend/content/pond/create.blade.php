...
@section('title', __('নতুন জলাশয় লাইসেন্স যুক্ত'))
...
<x-backend.card>
    <x-slot name="header">
        @lang('নতুন জলাশয় লাইসেন্স যুক্ত করুন')
    </x-slot>
    ...
    <x-slot name="body">
        ...
        @endif
        {{ html()->form('POST', route('admin.pond-license.store'))->id('ownerForm')->attribute('enctype', 'multipart/form-data')->attribute('next', 'fee-tab')->open() }}
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="from_date[license_fee_from_yy]" id="license_fee_from_yy">
                                    ...
                                    @for ($i = date('Y',strtotime('+6 years')); $i >= 1893; $i--)
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered" id="license_moujas">
                            ...
                            <tr>
                                ...
                                <td style="width:10%;">
                                    <input type="text" name="mouja[0][property_amount]" id="mouja_total_amount_0" placeholder="জমির পরিমাণ" class="form-control" maxlength="11" />
                                </td>

                                <td style="width:10%;">
                                    <input type="text" name="mouja[0][leased_area]" id="leased_area_0" placeholder="লীজকৃত জমি" class="form-control" maxlength="11" />
                                </td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <textarea rows="2" col="5" class="form-control" id="pond_plot_no" name="pond_plot_no"></textarea>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="land_type" id="inlineRadio1" value="12" checked>
                            <label class="form-check-label" for="inlineRadio1">সারা বছর পানি থাকে (১২ মাস)</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="land_type" id="inlineRadio2" value="6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input type="date" class="form-control" name="land_map_date" id="exampleFormControlInput16" value="{{ old('land_map_date') }}" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control ledger_amount" id="exampleFormControlInput21" placeholder="কি.মি" name="land_map_kilo" value="{{ old('land_map_kilo') }}" maxlength="11" />
                    </div>
                </div>
